		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#marcondesfioriinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"marcondesfioriinvoices-display": {
								"semanticObject": "marcondesfioriinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=marcondesfiori.invoices",
									"url": sap.ui.require.toUrl("marcondesfiori/invoices")
								}
							}
						}
					}
